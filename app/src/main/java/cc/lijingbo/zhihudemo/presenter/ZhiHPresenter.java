...
public class ZhiHPresenter implements IZhiHPresenter {
    ...
    public void getZhiHLatest() {
        ...
        call.enqueue(new Callback<ZhiHNewsBean>() {
            @Override
            public void onResponse(Call<ZhiHNewsBean> call, Response<ZhiHNewsBean> response) {
...
//          mPref.edit().putString(Constants.LATEST_JSON, new Gson().toJson(body)).commit();
            ...
            @Override
            public void onFailure(Call<ZhiHNewsBean> call, Throwable t) {
    ...
    @Override
    public void getZhiHBefore(final int time) {
...
//    String json = mPref.getString(Constants.LATEST_JSON, null);
    ...
    @Override
    public void getZhiHFromCache(int time) {
    ...
    public void getThemes() {
        ...
        themes.enqueue(new Callback<ThemesBean>() {
            @Override
            public void onResponse(Call<ThemesBean> call, Response<ThemesBean> response) {
                if (response.isSuccessful()) {
            ...
            @Override
            public void onFailure(Call<ThemesBean> call, Throwable t) {
            }
        });
    }
}
